//
//  PlayRecordViewController+Audio
//  PitchPerfect
//
...
extension PlayRecordViewController {
    ...
    func playSound(rate rate: Float? = nil, pitch: Float? = nil, echo: Bool = false, reverb: Bool = false) {
        ...
        audioPlayerNode.scheduleFile(audioFile, atTime: nil) {
            ...
            self.stopTimer = NSTimer(timeInterval: delayInSeconds, target: self, selector: #selector(PlayRecordViewController.stopAudio), userInfo: nil, repeats: false)
